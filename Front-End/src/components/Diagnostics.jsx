...
const Diagnostics = (props) => {
    const handleChange = (state, e) =>  {
        ...
        console.log('state.setupDetails', state.setupDetails, state.setupDetails[e.target.id]);
        //create an object
        let newsetupDetails;

        if(e.target.checked === true){
            console.log("1st block")
            console.log(state.setupDetails[e.target.id]);
            setStat("yes");
            newsetupDetails =  {
                ...state.setupDetails
            };
            newsetupDetails[e.target.id] = 'yes'
            setValue(e.target.id, "no");

            console.log('updated', state.setupDetails[e.target.id]);
            ...
            newsetupDetails[e.target.id] = 'no'
            setValue(e.target.id, "yes");
            console.log('updated', state.setupDetails[e.target.id]);
                                    ...
                                    render={(props) => {
                                        return (
                                            <Switch
                                                ...
                                                name="R8OutputCFG"
                                                onChange={(e)=>(actions.handleChange(e))}
                                                value={state.setupDetails.R8OutputCFG}
                                                checked={state.setupDetails.R8OutputCFG === "yes"}
                                                //checked={true}
                                            />
                                        );
                                    }}
                                ...
                                <Controller 
                                    ...
                                    render={(props) => {
                                        return (
                                            <Switch
                                                size="medium"
                                                id="ShrinkedClassesStats"
                                                type="checkbox"
                                                name="ShrinkedClassesStats"
                                                onChange={(e)=>(actions.handleChange(e))}
                                                value={state.setupDetails.ShrinkedClassesStats}
                                                checked={state.setupDetails.ShrinkedClassesStats === "yes"}
                                                //checked={true}
                                            />
                                        );
                                    }}

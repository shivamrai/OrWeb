            ...
            <Paper elevation={1} className={classes.paper}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} className={classes.grid}>
                        <Typography>This section specifies the rules that help us keep some important exceptions from
                            obfuscation as the applications may cause runtime issues due to obfuscation of these
                            classes/libraries. There are some links added to get a guide on covered
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className={classes.form}>
                            <section className={classes.section}>
                                <Typography>Do you have any{" "}
                                    ...
                                    {" "}classes(classes requiring serialization from GSON on initialization)(these will
                                    be added to skip since these may cause issues with application behavior or
                                    bugs)?</Typography>
                                <Controller
                                    as={
                                    ...
                                    ref={register}
                                />
                                <Typography>Known issues with GSON <a
                                    href="https://r8.googlesource.com/r8/+/refs/heads/master/compatibility-faq.md">here</a>
                                </Typography>
                            </section>
                            <Grid item xs={24} sm={12}>
                                <section className={classes.section}>
                                    ...
                                    <Controller
                                        ...
                                        ref={register}
                                    />
                                    <Typography>Add those classes in format <i>"class
                                        in.uncod.android.bypass.Document"</i> in below Text Field (case
                                        sensitive)</Typography>
                                    <Typography>These will be added to skip since these may cause issues with
                                        application behavior or bugs</Typography>
                                </section>
                            </Grid>
                            <section className={classes.section}>
                                ...
                                >
                                    <Link to="\">these</Link>
                                </ObfuscationTooltip> classes/packages/libraries in below Text Field (case sensitive and
                                    specify complete names)<a
                                        href="https://r8.googlesource.com/r8/+/refs/heads/master/compatibility-faq.md">here</a>
                                </Typography>
                                <Typography>Specify complete names so that correct packages can be targeted, eg for
                                    OkHttp3 <i>okhttp3.internal.publicsuffix.PublicSuffixDatabase </i><a
                                        href="https://github.com/square/okhttp/blob/master/okhttp/src/main/resources/META-INF/proguard/okhttp3.pro">Read
                                        about the fix here.</a></Typography>
                                ...
                                </ObfuscationTooltip> type for R8
                                    considerations <i>com.path.to.your.EnumArg/ParcelableArg/SerializableArg </i><a
                                        href="https://developer.android.com/guide/navigation/navigation-pass-data#proguard_considerations">More
                                        about this issue</a></Typography>
                            </section>
                        </form>
                    </Grid>

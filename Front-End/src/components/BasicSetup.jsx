            ...
            <Paper elevation={1} className={classes.paper}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} className={classes.grid}>
                        <Typography>This section deals about some basic choices that you can make regarding obfuscation
                            and R8 features for your project. There are some additional experimental flags included to
                            work.</Typography>
                    </Grid>
                    <Grid item xs={24} sm={12} alignContent="flex-start" alignItems='flex-start'>
                        <form onSubmit={handleSubmit(onSubmit)} class={classes.form}>
                            ...
                            <section className={classes.section}>
                                ...
                                <Typography>This configuration puts R8 in full mode, R8 performs more aggressive
                                    optimizations, meaning that additional ProGuard configuration rules may be
                                    required.</Typography>
                            </section>
                        </form>
                    </Grid>
